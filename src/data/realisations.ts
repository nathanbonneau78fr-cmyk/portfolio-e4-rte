...
export const realisations: Realisation[] = [
  {
    titre:
      "Installation et administration d’un serveur Windows Server ",
    contexte:
    ...
    preuvesPdfAssociees: [
      {
        ...
        href: "/preuves/NATHAN E5/Réalisation-en-cours-de-formation/Installation-et-administration-d’un-serveur-Windows-Server-(services-de-base,rôles,maintenance)/procedure-windows.pdf",
      },
    ],
  },
  {
  ...
  {
    titre:
      "Mise en place d’une solution de sauvegarde et de restauration",
    contexte:
    ...
    imageAlt:
      "Sauvegarde et restauration de données avec disque et flèche de retour",
    competences: ["C1", "C5"],
    preuvesPdfAssociees: [
      {
        label: "Lab NFS",
  ...
  },
  {
    ...
    preuvesPdfAssociees: [
      ...
      {
        label: "Firewall filtrage",
        href: encodeURI(
          "/preuves/NATHAN E5/Réalisation-en-cours-de-formation/securisation-systeme-information-pare-feu-regles-filtrage/firewall-filtrage.pdf"
        ),
      },
    ],
  },
  ...
  },
  {
    ...
    imageAlt:
      "Virtualisation de serveurs avec plusieurs machines virtuelles",
    competences: ["C1", "C5", "C6"],
    preuvesPdfAssociees: [
      {
  ...
  {
  titre: "Veille sur les outils de gestion de parc informatique",
  contexte:
  ...
  preuvesPdfAssociees: [
    {
      label: "Accéder à la veille technologique",
      href: "/veille",
    },
  ],
},
  {
    titre: "Réalisation du portfolio et du tableau de synthèse pour l’épreuve E5",
    contexte:
      "Construction et mise à jour du portfolio E5 : structuration des réalisations, mise en cohérence et préparation des supports.",
    categorie: "formation",
    image: "/realisations/10_epreuve_e5_portfolio_tableau_de_synthese.png",
  ...
  },
  {
    ...
    preuvesPdfAssociees: [
      ...
      {
        label:
          "Gestion des mutations et modifications profils utilisateurs",
  ...
  },
  {
    ...
    imageAlt:
      "Communication aux utilisateurs avec message et support informatique",
    competences: ["C2", "C5"],
    preuvesPdfAssociees: [
      {
  ...
  {
    titre: "Gestion des droits d’accès : applications, logiciels et dérogations",
    contexte:
  ...
  {
    titre:
      "Mise à jour Windows 10 22H2 des postes de dispatching et VIP",
    contexte:
  ...
  },
  {
    ...
    imageAlt:
      "Administration Active Directory avec utilisateurs, groupes et outil de gestion",
    competences: ["C1", "C2", "C5"],
    preuvesPdfAssociees: [
      {
  ...
  },
  {
    ...
    imageAlt:
      "Sécurité après perte ou vol de matériel avec ordinateur et cadenas",
    competences: ["C1", "C2", "C5"],
    preuvesPdfAssociees: [
      {
        label:
          "Actions de sécurité suite à la perte ou au vol d'équipement RTE",
  ...
  {
    titre:
      "Installation et gestion des tokens RSA pour l’accès à distance sécurisé",
    contexte:
    ...
    preuvesPdfAssociees: [
      ...
      {
        label:
          "Installation de Soft Token RSA sur Smartphone - Hors parc RTE V2",
  ...
  },
  {
    ...
    categorie: "professionnel",
    image: "/realisations/21_approbation_des_demandes_des_utilisateurs.png",
  ...
  {
    titre:
      "Développement de compétences à l’aide de modules e-learning",
    contexte:
    ...
    imageAlt:
      "Modules e-learning avec écran de formation et validation des compétences",
    competences: ["C6"],
    preuvesPdfAssociees: [
      {
  ...
  },
  {
    ...
    imageAlt:
      "Boîte mail fonctionnelle avec enveloppe et paramètres d'accès",
    competences: ["C1", "C2", "C5"],
    preuvesPdfAssociees: [
      {
  ...
  {
    titre: "Suivi des tickets du périmètre SI",
    contexte:
    ...
    imageAlt:
      "Ticket de support informatique lié à l’animation de la filière SI",
    competences: ["C2", "C5"],
    preuvesPdfAssociees: [
      {
        label: "GoPro AFSI",
  ...
  {
    titre:
      "Gestion et maintien en condition opérationnelle du matériel SI",
    contexte:
    ...
    imageAlt:
      "Maintien en condition opérationnelle du matériel informatique",
    competences: ["C1", "C2", "C5"],
    preuvesPdfAssociees: [
      {
  ...
  {
    titre:
      "Mise à jour Windows 11 23H2 des postes de dispatching et VIP",
    contexte:
    ...
    preuvesPdfAssociees: [
      {
        label:
          "Procédure d’upgrade WIN11 23H2 des postes dispatching et VIP",
  ...
  {
    titre:
      "Former et accompagner les utilisateurs dans leur montée en compétences du SI",
    contexte:
    ...
    imageAlt:
      "Accompagnement des utilisateurs en montée en compétences du SI",
    competences: ["C2", "C5"],
    preuvesPdfAssociees: [
      {
        label:
  ...
  {
    titre:
      "Participation à l’amélioration du diaporama de présentation pour les alternants de RTE",
    contexte:
    ...
    imageAlt:
      "Amélioration d’un diaporama de présentation pour alternants",
    competences: ["C3"],
    preuvesPdfAssociees: [
      {
        label:
          "Participation à l’optimisation du support de présentation des métiers RTE pour les futurs alternants",
  ...
  {
    titre: "Immersion au sein des services réseaux, cybersécurité et coordination",
    contexte:
    ...
    imageAlt:
      "Participation à une immersion professionnelle dans un service informatique",
    competences: ["C6"],
    preuvesPdfAssociees: [
      {
